...
public class VehicleTrafficLight extends TrafficLight {
     ...
     */
    public VehicleTrafficLight(IntersectionType[] trafficLightsConstraint, int index, int timeFrame, int MIN_TIME_GREEN, int MAX_TIME_RED, int PREF_MIN_TIME_GREEN, int PREF_MAX_TIME_RED) {
     ...
     */
    public VehicleTrafficLight(IntersectionType[] trafficLightsConstraint, int index, int timeFrame, double priority, int MIN_TIME_GREEN, int MAX_TIME_RED, int PREF_MIN_TIME_GREEN, int PREF_MAX_TIME_RED, double trafficCoeff) {
